...
export default function SearchBar({ handleClose, $isSearchOpened }) {
  ...
  const [isSearching, searchResult, _searchError, search] = useAPI(req.search.user);
  ...
  return (
    <>
      <SearchBarWrapper as="div" $isSearchOpened={$isSearchOpened}>
        <TopNavElement.GoBackButton onClick={handleCloseWithHidingResult} title="계정 검색바 닫기" />
      ...
      <LoadingIndicator visible={isSearching}>
        검색중...
      </LoadingIndicator>
